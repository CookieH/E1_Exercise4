...
/**
 * This is the main class for the grid navigation, here we create the arbitrator
 * and add the behaviours
 * 
 * @author E1
 * 
 */
public class Junction {
	 ...
	 * 
	 * @param pilot
	 *            the differential pilot for the robot movement
	 * @param left
	...
	/**
	 * the run method is where the arbitrator is created, behaviours added and
	 * the arbitrator is started
	 */
	public void run() {
	...
	/**
	 * Gives the TakeTurn behaviour a list of instructions for it to follow.
	 * 
	 * @param directions
	...
	/**
	 * Returns the behaviour that is used for junction control
	 * 
	 * @return The TakeTurn behaviour of the robot which controls how it behaves
	...
	/**
	 * Called by the constructor. Sets up the robot.
	 */
	public void setup() {
		pilot.setTravelSpeed(10);
		turner = new TakeTurn(pilot, left, right);

		Behavior[] behaviours = { new Drive(pilot),
				new Adjust(pilot, left, right), turner };
	...
	public static void main(String[] args) {
		...
		Junction demo = new Junction(new DifferentialPilot(5.6, 12.9, Motor.C,
				Motor.B), new LightSensor(SensorPort.S2), new LightSensor(
				SensorPort.S4));
		demo.run();
	}
